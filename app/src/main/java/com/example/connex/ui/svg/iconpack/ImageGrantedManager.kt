...
public val IconPack.ImageGrantedManager: ImageVector
    get() {
        if (_imagegrantedmanager != null) {
            return _imagegrantedmanager!!
        }
        _imagegrantedmanager = Builder(name = "Imagegrantedmanager", defaultWidth = 166.0.dp,
                defaultHeight = 165.0.dp, viewportWidth = 166.0f, viewportHeight = 165.0f).apply {
...
private var _imagegrantedmanager: ImageVector? = null
