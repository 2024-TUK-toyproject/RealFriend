...
public val IconPack.ImageGrantedFounder: ImageVector
    get() {
        if (_ImageGrantedFounder != null) {
            return _ImageGrantedFounder!!
        }
        _ImageGrantedFounder = Builder(name = "Imagegrantedfounder", defaultWidth = 176.0.dp,
                defaultHeight = 178.0.dp, viewportWidth = 176.0f, viewportHeight = 178.0f).apply {
            path(fill = SolidColor(Color(0xFF365FF0)), stroke = null, strokeLineWidth = 0.0f,
...
private var _ImageGrantedFounder: ImageVector? = null
