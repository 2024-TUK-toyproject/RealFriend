...
public val IconPack.IcNotification: ImageVector
    get() {
        ...
        _icNotification = Builder(name = "IcNotification", defaultWidth = 20.0.dp, defaultHeight =
            ...
            group {
                path(fill = SolidColor(Color(0xFF1C1B1F)), stroke = null, strokeLineWidth = 0.0f,
                    ...
                    curveTo(7.7935f, 0.05f, 6.1267f, 0.6729f, 4.7898f, 1.7744f)
                    curveTo(3.4528f, 2.8758f, 2.5224f, 4.3925f, 2.1464f, 6.0834f)
                    lineTo(0.9206f, 11.5959f)
                    ...
                    curveTo(4.6137f, 15.0f, 4.2442f, 14.9159f, 3.9067f, 14.7539f)
